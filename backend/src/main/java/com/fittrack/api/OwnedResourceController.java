...
public class OwnedResourceController {
 ...
 @PostMapping("/{resource:profile|fitness-profile|daily-metrics|body-metrics|workouts|workout-sessions|workout-templates|plan-sessions|personal-records|goals|meals|food-scans|ai-usage|habits|habit-logs|reminders|health-devices|coach-notifications|exercises|foods}") public Map<String,Object> create(@PathVariable String resource,@RequestBody Map<String,Object> b,@AuthenticationPrincipal String u){return service.create(resource,b,u);}
 @PutMapping("/{resource:fitness-profile|daily-metrics|body-metrics|workouts|workout-sessions|workout-templates|plan-sessions|personal-records|goals|meals|food-scans|ai-usage|habits|habit-logs|reminders|health-devices|coach-notifications|exercises|foods}") public Map<String,Object> update(@PathVariable String resource,@PathVariable String id,@RequestBody Map<String,Object>b,@AuthenticationPrincipal String u){return service.update(resource,id,b,u);}
 ...
 @DeleteMapping("/{resource:fitness-profile|daily-metrics|body-metrics|workouts|workout-sessions|workout-templates|plan-sessions|personal-records|goals|meals|food-scans|ai-usage|habits|habit-logs|reminders|health-devices|coach-notifications|exercises|foods}") public void delete(@PathVariable String resource,@PathVariable String id,@AuthenticationPrincipal String u){service.delete(resource,id,u);}
